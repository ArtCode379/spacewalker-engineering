Generate and install the app icon for /tmp/spacewalker-engineering.
...
/tmp/spacewalker-engineering/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/spacewalker-engineering/app/src/main/res/drawable/icon.png`.
